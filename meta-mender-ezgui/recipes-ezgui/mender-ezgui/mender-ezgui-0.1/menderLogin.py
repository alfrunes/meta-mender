...
# Form implementation generated from reading ui file 'menderLogin.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logInBtn.setGeometry(QtCore.QRect(245, 355, 70, 24))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        self.quitBtn.setGeometry(QtCore.QRect(105, 355, 70, 24))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.ButtonText, brush)
        ...
        self.server_addr.setGeometry(QtCore.QRect(120, 150, 180, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.server_addr.setAccessibleName("")
        ...
        self.domain_label.setGeometry(QtCore.QRect(120, 137, 100, 14))
        self.domain_label.setObjectName("domain_label")
        self.serverCheckBox = QtWidgets.QCheckBox(self.centralwidget)
        self.serverCheckBox.setGeometry(QtCore.QRect(180, 180, 120, 16))
        ...
        self.showPwd.setGeometry(QtCore.QRect(180, 308, 120, 20))
